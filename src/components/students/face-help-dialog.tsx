...
import { getFacePromptOptions as getPromptOptions } from "@/features/ai-engine/prompts"

export function FaceHelpDialog() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>관상 분석 프롬프트 가이드</DialogTitle>
          <DialogDescription>
            각 프롬프트의 관상 분석 관점과 활용 방법을 확인하세요
          </DialogDescription>
        </DialogHeader>
