...
import { getSajuPromptOptions as getPromptOptions } from "@/features/ai-engine/prompts"

export function SajuHelpDialog() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>사주 분석 프롬프트 가이드</DialogTitle>
          <DialogDescription>
          ...
          <div className="space-y-4 pr-2">
            ...
            <div className="rounded-lg bg-blue-50 border border-blue-200 p-3 text-xs text-blue-700 space-y-1">
              ...
              <ul className="list-disc list-inside space-y-0.5">
                <li>LLM 제공자를 선택해야 전문 프롬프트를 사용할 수 있습니다</li>
                <li>&quot;추가 요청&quot; 입력란으로 학생 상황에 맞는 맞춤 분석이 가능합니다</li>
                <li>분석 이력에서 과거 결과를 비교할 수 있습니다</li>
              </ul>
            </div>
          </div>
        </ScrollArea>
