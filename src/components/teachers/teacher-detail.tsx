        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              <p className="font-medium">
                {teacher.name}
                {hanjaName && (
                  <span className="ml-1 text-muted-foreground">({hanjaName})</span>
                )}
              </p>
            </div>
            <div className="space-y-1">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {teacher.birthTimeHour !== null && (
              <div className="space-y-1">
                <p className="text-sm text-muted-foreground">태어난 시간</p>
                <div className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <p className="text-sm text-muted-foreground">담당 학생</p>
              <div className="flex items-center gap-2">
