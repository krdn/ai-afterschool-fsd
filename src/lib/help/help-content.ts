...
const helpContent: HelpTopic[] = [
  ...
  // ========== Counseling (상담 관리) ==========
  {
    ...
    category: 'counseling',
    title: '상담 관리 소개',
    summary: '상담 관리 시스템의 전체 구조와 주요 기능을 안내합니다.',
    content: [
      '# 상담 관리 시스템',
      '',
      '상담 관리는 **선생님-학생 상담**의 전체 생명주기를 지원합니다.',
      '',
      '## 주요 기능',
      '',
      '| 기능 | 설명 |',
      '|------|------|',
      '| **상담 기록** | 완료된 상담 기록 조회, 필터링, 통계 |',
      '| **예약 관리** | AI 기반 4단계 마법사로 상담 예약 등록 |',
      '| **예약 캘린더** | 월/주 단위 캘린더로 예약 시각화 |',
      '| **세션 라이브** | 실시간 상담 진행, 체크리스트, AI 자료 참조 |',
      '',
      '## 전체 흐름',
      '',
      '```',
      '1. 예약 등록 (4단계 마법사)',
      '   ├─ Step 1: 기본 정보 (날짜/시간/학생/학부모/주제)',
      '   ├─ Step 2: AI 학생 분석 보고서 생성 + 교사 승인',
      '   ├─ Step 3: AI 상담 시나리오 생성 + 교사 승인',
      '   └─ Step 4: AI 학부모 공유 메시지 생성',
      '',
      '2. 상담 진행 (세션 라이브)',
      '   ├─ AI 자료 참조 (분석/시나리오/학부모 메시지)',
      '   ├─ 체크리스트 실시간 관리',
      '   └─ 상담 완료 (유형/소요시간/요약/만족도/후속조치)',
      '',
      '3. 상담 기록 관리',
      '   └─ 기록 조회, 필터, 통계 확인',
      '```',
      ...
      '## AI 활용 포인트',
      '',
      '- **학생 분석 보고서**: 학생의 성향(MBTI/사주/관상 등), 성적, 이전 상담 이력을 종합 분석',
      '- **상담 시나리오**: 분석 보고서를 기반으로 30분 상담 시나리오 자동 생성',
      '- **학부모 메시지**: 민감 정보를 제외한 학부모용 안내 메시지 생성',
      '- **상담 요약**: 상담 완료 후 AI가 구조화된 요약 제공',
    ],
    relatedTopics: ['counseling-reservation', 'counseling-ai-pipeline', 'counseling-session-live'],
  },
  {
    id: 'counseling-history',
    category: 'counseling',
    title: '상담 기록 관리',
    summary: '완료된 상담 기록을 조회하고 관리하는 방법입니다.',
    content: [
      '# 상담 기록 관리',
      '',
      '## 기록 조회',
      '',
      '상담 관리 페이지의 **"상담 기록"** 탭에서 모든 상담 기록을 확인할 수 있습니다.',
      '',
      '### 필터링 옵션',
      '',
      '| 필터 | 설명 |',
      '|------|------|',
      '| **검색** | 학생 이름 또는 상담 요약으로 검색 |',
      '| **상담 유형** | 학업/진로/심리/행동 유형별 필터 |',
      '| **기간** | 특정 기간의 상담만 조회 |',
      '| **후속 조치** | 후속 조치가 필요한 상담만 필터 |',
      '',
      '## 통계 위젯',
      '',
      '페이지 상단에 핵심 통계가 표시됩니다:',
      '',
      '- **총 상담 건수**: 전체 기간 누적 상담 수',
      '- **이번 달**: 현재 월 상담 수',
      '- **평균 소요 시간**: 상담당 평균 시간 (분)',
      '- **후속 조치 필요**: 아직 처리되지 않은 후속 조치 건수',
      '',
      '## 상담 기록 상세',
      '',
      '기록을 클릭하면 상세 정보를 확인할 수 있습니다:',
      '',
      '- 학생/교사 정보',
      '- 상담 유형 및 소요 시간',
      '- 상담 요약 (교사 작성 + AI 요약)',
    ...
    relatedTopics: ['counseling-overview', 'counseling-reservation'],
  },
  {
    id: 'counseling-reservation',
    category: 'counseling',
    title: '예약 등록 가이드',
    summary: '4단계 마법사를 통한 상담 예약 등록 과정을 상세히 안내합니다.',
    content: [
      '# 상담 예약 등록 가이드',
      '',
      '## 시작하기',
      ...
      '| 항목 | 설명 | 필수 |',
      '|------|------|------|',
      '| **날짜** | 캘린더에서 상담 날짜 선택 (과거 날짜 불가) | ✅ |',
      '| **시간** | 30분 단위 슬롯에서 선택 (이미 예약된 시간은 비활성) | ✅ |',
      '| **학생** | 검색하여 학생 선택 | ✅ |',
      '| **학부모** | 선택한 학생의 학부모 중 선택 | 선택 |',
      '| **상담 주제** | 상담의 주요 주제 입력 (2~200자) | ✅ |',
      '',
      '> **팁**: 상담 주제는 구체적으로 작성할수록 AI가 더 좋은 시나리오를 생성합니다.',
      '> 예: "수학 성적 저하 원인 파악" (✅) vs "학업" (❌)',
      '',
      '## Step 2: 학생 인사이트 + AI 분석 보고서',
      '',
      '### 학생 인사이트 자동 로드',
      '',
      '선택한 학생의 데이터가 자동으로 표시됩니다:',
      '',
      '- **학생 성향**: MBTI, 사주 분석 등 성향 데이터',
      '- **최근 성적**: 최근 10개 성적 기록',
      '- **최근 상담 이력**: 최근 5개 상담 요약',
      '',
      '### AI 분석 보고서 자동 생성',
      '',
      'AI가 학생 데이터를 종합하여 **분석 보고서**를 자동 생성합니다.',
      '',
      '보고서 구성:',
      '- **학생 성향 종합**: MBTI/성격 유형, 강점, 유의점',
      '- **학업 현황**: 과목별 성적 테이블, 강점/약점 과목',
      '- **상담 이력 패턴**: 반복 주제, 진전 사항, 미해결 과제',
      '- **이번 상담 연관성**: 주제 연결, 예상 반응, 주의 포인트',
      '',
      '### 교사 검토 & 승인',
      '',
      '1. 생성된 보고서를 **직접 편집** 가능 (마크다운)',
      '2. 수정이 완료되면 **"승인"** 버튼 클릭',
      '3. 승인된 보고서가 다음 단계(시나리오)의 입력으로 사용됨',
      '',
      '> **"AI 보완 없이 진행"** 버튼으로 AI 단계를 모두 건너뛸 수 있습니다.',
      '',
      '## Step 3: AI 상담 시나리오',
      '',
      '승인된 분석 보고서를 기반으로 **30분 상담 시나리오**가 생성됩니다.',
      '',
      '시나리오 구성:',
      '- **도입 (5분)**: 라포 형성, 첫 질문 예시',
      '- **본론 (20분)**: 핵심 질문 + 예상 반응 + 대응 전략 (표 형식)',
      '- **마무리 (5분)**: 합의사항 정리, 후속 조치, 다음 상담 연결',
      '',
      '시나리오도 **직접 편집 가능**합니다.',
      '',
      '## Step 4: 학부모 공유 메시지',
      '',
      '상담 시나리오를 기반으로 **학부모용 안내 메시지**가 생성됩니다.',
      '',
      '포함 내용:',
      '- 상담 안내 (일시, 주제)',
      '- 사전 준비 요청',
      '- 따뜻한 안내 문구',
      '',
      '> **주의**: 학부모 메시지에는 심리 분석, 성격 진단 등 민감 정보가 포함되지 않습니다.',
      '',
      '## 예약 완료',
      '',
      '**"예약 등록"** 버튼을 클릭하면:',
      '- 예약이 DB에 저장됩니다',
      '- AI 생성 문서들이 상담 세션에 연결됩니다',
      '- 예약 목록에서 확인 가능합니다',
    ],
    relatedTopics: ['counseling-ai-pipeline', 'counseling-ai-prompts', 'counseling-overview'],
  },
  {
    id: 'counseling-ai-pipeline',
    category: 'counseling',
    title: 'AI 분석 파이프라인',
    summary: 'AI가 분석 보고서, 시나리오, 학부모 메시지를 생성하는 과정을 설명합니다.',
    content: [
      '# AI 분석 파이프라인',
      '',
      '## 3단계 파이프라인 구조',
      '',
      '상담 예약 시 AI는 3단계에 걸쳐 문서를 생성합니다. 각 단계의 출력이 다음 단계의 입력으로 연결됩니다.',
      '',
      '```',
      '학생 데이터 + 상담 주제',
      '       ↓',
      ...
      '| 항목 | 내용 |',
      '|------|------|',
      '| **입력** | 학생 정보, 성향 데이터(MBTI/사주/관상 등), 최근 성적, 이전 상담 이력 |',
      '| **출력** | 마크다운 보고서 (성향 종합, 학업 현황, 상담 패턴, 연관성) |',
      '| **토큰** | 최대 1,000 토큰 |',
      '| **온도** | 0.3 (일관성 중시) |',
      '| **기능 매핑** | `counseling_analysis` |',
      '',
      '### 2단계: 상담 시나리오',
      '',
      '| 항목 | 내용 |',
      '|------|------|',
      '| **입력** | 승인된 분석 보고서, 학생명, 상담 주제, 성향 요약 |',
      '| **출력** | 30분 시나리오 (도입 5분 → 본론 20분 → 마무리 5분) |',
      '| **토큰** | 최대 1,500 토큰 |',
      '| **온도** | 0.5 (창의성 포함) |',
      '| **기능 매핑** | `counseling_scenario` |',
      '',
      '### 3단계: 학부모 메시지',
      '',
      '| 항목 | 내용 |',
      '|------|------|',
      '| **입력** | 학생명, 상담 주제, 예약 일시, 승인된 시나리오 |',
      '| **출력** | 학부모 안내 메시지 (민감 정보 제외) |',
      '| **토큰** | 최대 500 토큰 |',
      '| **온도** | 0.3 (일관성 중시) |',
      '| **기능 매핑** | `counseling_parent` |',
      '',
      '## 교사 승인 프로세스',
      '',
      '각 단계에서 AI가 생성한 내용은 교사가 **반드시 검토**합니다:',
      '',
      '1. 생성된 문서를 마크다운 에디터에서 직접 수정 가능',
      '2. **"승인"** 버튼으로 다음 단계로 진행',
      '3. **"재생성"** 버튼으로 새로 생성 요청',
      '4. 모델 변경: 각 단계에서 다른 LLM 모델을 선택하여 생성 가능',
      '',
      '## LLM 모델 선택',
      '',
      '각 생성 단계에서 **모델 선택 드롭다운**을 통해 다른 모델로 생성할 수 있습니다.',
      '',
      '기본값은 관리자가 설정한 **기능 매핑(Feature Mapping)** 규칙에 따라 자동 선택됩니다.',
    ],
    relatedTopics: ['counseling-reservation', 'counseling-ai-prompts', 'counseling-prompt-customization'],
  },
  {
    id: 'counseling-ai-prompts',
    category: 'counseling',
    title: 'AI 프롬프트 구조',
    summary: '각 단계별 AI 프롬프트의 구성, 입력 데이터, 출력 형식을 상세히 설명합니다.',
    content: [
      '# AI 프롬프트 구조',
      '',
      '## 프롬프트 구성 원칙',
      '',
      '모든 상담 AI 프롬프트는 다음 구조를 따릅니다:',
      '',
      '```',
      '1. 역할 정의 ("너는 ~~ 전문가야")',
      '2. 컨텍스트 정보 (학생 데이터, 상담 주제 등)',
      '3. 출력 형식 규격 (마크다운 구조, 섹션, 테이블)',
      '4. 작성 지침 (톤, 주의사항, 제약조건)',
      '```',
      '',
      '## 프롬프트별 상세',
      ...
      '- `{{grade}}` - 학년',
      '- `{{topic}}` - 상담 주제',
      '- `{{personalitySection}}` - 성향 데이터 (MBTI, 사주, 관상 등)',
      '- `{{previousSessionsSection}}` - 이전 상담 이력',
      '- `{{gradeHistorySection}}` - 최근 성적 기록',
      '',
      '**출력 형식**:',
      '- 학생 성향 종합 (MBTI/성격, 강점, 유의점)',
      '- 학업 현황 (과목별 표, 강점/약점)',
      '- 상담 이력 패턴 (반복 주제, 진전, 미해결)',
      '- 이번 상담 연관성 (주제 연결, 예상 반응)',
      '',
      '### 2. 상담 시나리오 프롬프트',
      '',
      ...
      '- `{{studentName}}` - 학생 이름',
      '- `{{topic}}` - 상담 주제',
      '- `{{approvedReport}}` - 교사가 승인한 분석 보고서',
      '- `{{personalitySummary}}` - 핵심 성향 요약 (1-2문장)',
      '',
      '**출력 형식** (30분 구성):',
      '- 도입 (5분): 분위기, 접근 방식, 첫 질문 예시',
      '- 본론 (20분): 질문별 예상 반응 표, 전환 포인트',
      '- 마무리 (5분): 합의사항, 후속 조치, 다음 연결',
      '',
      '### 3. 학부모 메시지 프롬프트',
      '',
      '**역할**: "학부모 커뮤니케이션 전문가"',
      ...
      '- `{{topic}}` - 상담 주제',
      '- `{{scheduledAt}}` - 상담 일시',
      '- `{{approvedScenario}}` - 승인된 시나리오',
      '',
      '**출력 특징**:',
      '- 따뜻하고 전문적인 어조',
      '- 심리 분석, 성격 진단 등 **민감 정보 절대 제외**',
      '- 상담 안내, 준비 요청, 예상 효과',
      '',
      '## 온도(Temperature) 설정',
      '',
      '| 단계 | 온도 | 이유 |',
      '|------|------|------|',
      '| 분석 보고서 | 0.3 | 정확하고 일관된 분석 |',
      '| 상담 시나리오 | 0.5 | 창의적인 질문과 대응 전략 |',
      '| 학부모 메시지 | 0.3 | 안정적이고 일관된 문체 |',
    ],
    relatedTopics: ['counseling-ai-pipeline', 'counseling-prompt-customization', 'counseling-reservation'],
  },
  {
    id: 'counseling-prompt-customization',
    category: 'counseling',
    title: '프롬프트 커스터마이징',
    summary: '관리자가 AI 프롬프트를 수정하여 생성 결과를 조절하는 방법입니다.',
    content: [
      '# 프롬프트 커스터마이징',
      '',
      '## 개요',
      '',
      '관리자(팀장 이상)는 **관리자 도구 > 상담 프롬프트** 탭에서 AI 프롬프트를 직접 수정할 수 있습니다.',
      '',
      '## 수정 가능한 프롬프트',
      '',
      '| 프롬프트 | 용도 |',
      ...
      '- 관리자가 직접 생성한 프롬프트',
      '- 자유롭게 수정/삭제 가능',
      '- 여러 프리셋 중 하나를 활성화하여 사용',
      '',
      '## 템플릿 변수 사용법',
      '',
      '프롬프트 내에서 `{{변수명}}` 형태로 동적 데이터를 삽입할 수 있습니다.',
      '',
      '예시:',
      '```',
      '{{studentName}} 학생의 {{topic}} 상담을 준비합니다.',
      '```',
      '',
      '→ 실행 시: "김민준 학생의 진로 고민 상담을 준비합니다."',
      '',
      '각 프롬프트 유형별로 사용 가능한 변수 목록이 편집 화면에 표시됩니다.',
      '',
      '## 수정 팁',
      '',
      '- **출력 형식**을 변경하면 UI 렌더링에 영향을 줄 수 있습니다 (마크다운 형식 유지 권장)',
      '- **온도(Temperature)**를 높이면 더 창의적이지만 일관성이 떨어집니다',
      '- **최대 토큰**을 늘리면 더 상세한 출력이 가능하지만 비용이 증가합니다',
      '- 변경 후에는 **미리보기** 기능으로 변수 치환 결과를 확인하세요',
    ],
    relatedTopics: ['counseling-ai-prompts', 'counseling-ai-pipeline'],
  },
  {
    id: 'counseling-session-live',
    category: 'counseling',
    title: '상담 세션 진행',
    summary: '실시간 상담 진행, 체크리스트 관리, AI 자료 참조 방법을 안내합니다.',
    content: [
      '# 상담 세션 진행',
      '',
      '## 세션 시작',
      '',
      '예약 목록에서 **"기록 작성"** 또는 **"상담 시작"** 버튼을 클릭합니다.',
      '',
      '## 화면 구성',
      '',
      '```',
      ...
      '```',
      '',
      '> 상단/하단 패널의 비율은 **드래그**로 조절 가능합니다.',
      '',
      '## AI 자료 참조',
      '',
      '예약 등록 시 생성한 AI 문서 3종을 **읽기 전용**으로 참조할 수 있습니다:',
      '',
      '- **분석 보고서**: 학생 성향, 학업 현황, 상담 패턴',
      '- **상담 시나리오**: 도입/본론/마무리 시나리오',
      '- **학부모 메시지**: 학부모 공유용 메시지',
      '',
      '## 체크리스트',
      '',
      '상담 중 확인할 항목들을 관리합니다:',
      '',
      '- **체크/해제**: 클릭으로 상담 중 확인 여부 표시',
      '- **메모 추가**: 각 항목에 인라인 메모 입력',
      '- **항목 추가**: "+" 버튼으로 새 항목 추가',
      '- **순서 변경**: 드래그 앤 드롭으로 순서 변경',
      '- **자동 저장**: 변경 사항이 실시간으로 DB에 저장됨',
      '',
      '## 상담 완료',
      '',
      '**"상담 완료"** 버튼을 클릭하면 완료 폼이 표시됩니다:',
      '',
      '| 항목 | 설명 |',
      '|------|------|',
      '| **상담 유형** | 학업/진로/심리/행동 중 선택 |',
      '| **소요 시간** | 자동 기록 (수정 가능) |',
      '| **상담 요약** | 체크리스트 기반 자동 생성 (편집 가능) |',
      '| **만족도** | 1~5 별점 |',
      '| **후속 조치** | 필요 여부 + 일자 설정 |',
    ],
    relatedTopics: ['counseling-reservation', 'counseling-overview'],
  },
  {
    id: 'counseling-calendar',
    category: 'counseling',
    title: '예약 캘린더',
    summary: '월/주 단위 캘린더로 예약을 시각적으로 관리합니다.',
    content: [
      '# 예약 캘린더',
      '',
      '## 기능',
      '',
      '**"예약 캘린더"** 탭에서 월/주 단위로 예약을 시각적으로 확인할 수 있습니다.',
      '',
      '## 월간 뷰',
      '',
      '- 각 날짜 셀에 예약 건수 표시',
      '- 날짜를 클릭하면 해당 날짜의 예약 목록이 인라인으로 표시',
      '- 이전/다음 달 이동',
      '',
      '## 주간 뷰',
      '',
  ...
  {
    id: 'counseling-troubleshooting',
    category: 'counseling',
    title: '상담 관리 문제 해결',
    summary: 'AI 생성 실패, 예약 충돌 등 일반적인 문제의 해결 방법입니다.',
    content: [
      '# 상담 관리 문제 해결',
      '',
      '## AI 콘텐츠 생성 실패',
      ...
      '### 증상',
      '- "시나리오 생성 실패" 에러 표시',
      '- "분석 보고서를 생성할 수 없습니다" 메시지',
      '',
      '### 원인과 해결',
      '',
      '**1. LLM 제공자 미설정**',
      '- 관리자 > LLM 제공자에서 최소 1개 제공자가 활성화되어 있는지 확인',
      '- 기능 매핑(Feature Mapping)에서 `counseling_analysis`, `counseling_scenario`, `counseling_parent` 매핑 확인',
      '',
      '**2. API 호출 한도 초과 (Rate Limit)**',
      '- Gemini 무료 티어는 분당 호출 수가 제한됩니다',
      '- 해결: 30~60초 후 **"재시도"** 버튼 클릭',
      '- 장기 해결: 유료 플랜 전환 또는 다중 제공자 등록',
      '',
      '**3. 네트워크 오류**',
      '- 인터넷 연결 확인',
      '- VPN/프록시 설정 확인',
      ...
      '',
      '### 해결',
      '- 학생의 성향 분석(MBTI, 사주 등)을 먼저 진행',
      '- 성적 관리에서 성적 데이터 입력',
      '- 데이터가 없어도 AI가 가용한 정보로 보고서를 생성합니다',
      '',
      '## 마크다운 편집기 문제',
      '',
      '### 증상',
      ...
      '',
      '### 해결',
      '- 편집 후 반드시 **"승인"** 버튼을 클릭해야 합니다',
      '- 에디터 내에서 직접 수정한 내용은 해당 단계에만 적용됩니다',
    ],
    relatedTopics: ['counseling-ai-pipeline', 'connection-failed', 'rate-limit'],
  },
];
